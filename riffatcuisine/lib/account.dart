...
class AccountPage extends StatefulWidget {
  ...
  AccountPage({required this.enteredUsername});
...
class _AccountPageState extends State<AccountPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration(milliseconds: 500), () async {
      var data = await userdb.getUserByUsername(widget.enteredUsername);
      if (data != null) {
        ...
        print(" Not any user with id of " + widget.enteredUsername.toString());
      }
    });
    super.initState();
  }
